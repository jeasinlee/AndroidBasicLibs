...
import cn.wwah.common.JsonUtils;
import cn.wwah.common.cipher.MD5;
...
public class DiskCache implements ICache {
    ...
    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, JConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, JConfig.CACHE_DISK_DIR)));
    }
